...
void setup(){
  ...
  btns.add(new buttons((window.innerWidth-30)/7, 650, "https://imgur.com/p239OFB.png", "https://www.youtube.com/channel/UCdu1_2dPytXh_WvIbO6oRpA", 255, "YouTube Channel"));
}
void draw(){
  textAlign(LEFT);
  rectMode(CENTER);
  ...
  text("Music", 20, portfolio*6.6-(btns.get(3).ypos-btns.get(3).pos.y)/2);
